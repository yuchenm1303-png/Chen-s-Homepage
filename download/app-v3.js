...
function installOriginalStyleCursor() {
  ...
  const setVisible = (nextVisible) => {
    ...
    visible = nextVisible;
    cursorDot.classList.toggle("cursor-visible", nextVisible);
    cursorFollow.classList.toggle("cursor-visible", nextVisible);
  };
  ...
  window.addEventListener("pointerdown", () => cursorFollow.classList.add("pressed"), { passive: true });
  window.addEventListener("pointerup", () => cursorFollow.classList.remove("pressed"), { passive: true });
