(() => {
  ...
  /*
   * Restore the previous star count and coordinates, while keeping the five
   * highlighted stars that formed a row across the upper area removed.
   * The smaller visual scale remains controlled by star-refinement.css.
   */
  const featuredStars = [
